...
A VS Code extension that automatically resolves TailwindCSS optimization warnings and class conflicts with a single click, using exact diagnostic ranges and a single `WorkspaceEdit` so every change stays precise and instantly undoable.

| | |
|---|---|
| **Stack** | TypeScript, VS Code Extension API |
| **Scale** | Supports JS, TS, Vue, and Blade file types |
| **Performance** | Precise diagnostic-range edits (no document-wide search) |
| **Security** | Non-destructive batch edits, fully reversible via standard undo |
| **Impact** | Published on the VS Code Marketplace |
| **Repository** | [View Repo](https://github.com/KedarGhadyalji/tailwind-warning-auto-fix) |

</details>

<details>
<summary><b>🌱 Spawn — A Simple Git Clone</b></summary>
<br/>

A Git clone built from scratch in Python that replicates core version-control primitives — object storage, commit hierarchies, branching, and a staging area — through a clean CLI.

| | |
|---|---|
| **Stack** | Python |
| **Scale** | Object storage, branching, and commit history visualization |
| **Performance** | SHA-1 hashing and zlib compression for data integrity |
| **Security** | Snapshot-based tracking mirroring Git's internal data model |
| **Impact** | Educational deep-dive into how version control systems manage data |
| **Repository** | [View Repo](https://github.com/KedarGhadyalji/Spawn_Git_Clone) |

</details>

<details>
<summary><b>🖥️ PixelJar — A Multi-Language IDE</b></summary>
<br/>

A production-grade, multi-language code playground with a cloud-based execution engine, a customizable Monaco Editor workspace, and a physics-based "Sticker Login" authentication layer.

| | |
|---|---|
| **Stack** | Next.js, Clerk, Convex, Framer Motion, Tailwind CSS |
| **Scale** | 10+ sandboxed execution runtimes |
| **Performance** | Ultra-low latency script execution with cinematic route transitions |
| **Security** | Server-side sandboxed runtime execution |
| **Impact** | Combines professional-grade UX with hardware-accelerated micro-interactions |
| **Repository** | [View Repo](https://github.com/KedarGhadyalji/PixelJar) |

</details>

<details>
<summary><b>📝 CraftedCV — AI-Powered Resume Builder</b></summary>
<br/>

A full-stack resume builder using Generative AI to give real-time, context-aware suggestions for summaries and bullet points, with ATS-optimized templates and instant PDF export.

| | |
|---|---|
| **Stack** | React, JavaScript, Tailwind CSS, Gemini API, MongoDB |
| **Scale** | Live preview with real-time content generation |
| **Performance** | Instant PDF export pipeline |
| **Security** | Structured data handling across the resume-building workflow |
| **Impact** | ATS-optimized layouts built to improve pass-through rates |
| **Repository** | [View Repo](https://github.com/KedarGhadyalji/craftedcv) |

</details>

<details>
<summary><b>🔍 AnalyzedCV — Resume Diagnostic Tool</b></summary>
<br/>

A career-strategist tool that performs semantic analysis to score how well a profile matches a specific job description, going beyond basic keyword matching.

| | |
|---|---|
| **Stack** | React, JavaScript, Tailwind CSS, Gemini API, Puter.js |
| **Scale** | Full profile-to-job-description compatibility scoring |
| **Performance** | Semantic parsing beyond keyword-only matching |
| **Security** | Client-side profile evaluation workflow |
| **Impact** | Keyword-gap breakdown and optimization tips for candidates |
| **Repository** | [View Repo](https://github.com/KedarGhadyalji/AnalyzedCV) |

</details>

<details>
<summary><b>🧞 Genie — AI Pocket Agent</b></summary>
<br/>

A cross-platform mobile app that lets users create and manage small-scale AI agents in real time using the Kravix API.

| | |
|---|---|
| **Stack** | React Native, TypeScript, Tailwind CSS, Kravix API, Expo |
| **Scale** | Real-time AI agent orchestration on mobile |
| **Performance** | High-performance, responsive cross-platform experience |
| **Security** | Managed API-driven agent interactions |
| **Impact** | Brings edge-compatible AI utility tools directly to mobile |
| **Repository** | [View Repo](https://github.com/KedarGhadyalji/genie-ai-pocket-agent) |
...
## 🌐 Socials:
[![Instagram](https://img.shields.io/badge/Instagram-%23E4405F.svg?logo=Instagram&logoColor=white)](https://instagram.com/https://www.instagram.com/_kedar_ghadyalji_?igsh=MTJ0cjU2NDdjdDkyNw==) [![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?logo=linkedin&logoColor=white)](https://linkedin.com/in/https://www.linkedin.com/in/kedar-ghadyalji-98b7a6341) [![email](https://img.shields.io/badge/Email-D14836?logo=gmail&logoColor=white)](mailto:kedarghadyalji@gmail.com) 
...
<!--
# 📊 GitHub Stats:
![](https://github-readme-stats.vercel.app/api?username=KedarGhadyalji&theme=gruvbox&hide_border=false&include_all_commits=false&count_private=false&cache_seconds=42300)<br/>
![](https://nirzak-streak-stats.vercel.app/?user=KedarGhadyalji&theme=gruvbox&hide_border=false&cache_seconds=42300)<br/>
![](https://github-readme-stats.vercel.app/api/top-langs/?username=KedarGhadyalji&theme=gruvbox&hide_border=false&include_all_commits=false&count_private=false&layout=compact&cache_seconds=42300)


### ✍️ Daily Dev Quote
![](https://quotes-github-readme.vercel.app/api?type=horizontal&theme=gruvbox&cache_seconds=21600)
-->
...
![](https://github-contributor-stats.vercel.app/api?username=KedarGhadyalji&limit=5&theme=gruvbox&combine_all_yearly_contributions=true&cache_seconds=1800)
...
![Kedar's GitHub Stats](https://github-readme-stats.vercel.app/api?username=kedarghadyalji&show_icons=true&theme=radical)
-->
